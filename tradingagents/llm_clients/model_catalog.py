...
MODEL_OPTIONS: ProviderModeOptions = {
    ...
    "aliyun": {
        "quick": [
            ("Qwen3.5 Plus - Fast, cost-effective", "qwen3.5-plus"),
            ("Kimi K2.5 - Moonshot AI model", "kimi-k2.5"),
            ("GLM-5 - Zhipu AI model", "glm-5"),
            ("MiniMax M2.5 - High performance", "MiniMax-M2.5"),
        ],
        "deep": [
            ("MiniMax M2.5 - High performance", "MiniMax-M2.5"),
            ("Qwen3.5 Plus - Fast, cost-effective", "qwen3.5-plus"),
